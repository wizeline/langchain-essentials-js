...
async function main () {
  ...
  const physicsTemplate = `You are a very smart physics professor. You are great at answering questions about physics in a concise and easy to understand manner. When you don't know the answer to a question you admit that you don't know.
    After the response, add a "SOLVED BY PHYSICS PROFESOR"
    Here is a question:
    {input}
    `
  ...
  After the response, add a "SOLVED BY MATH PROFESOR"
    Here is a question:
    {input}`
  ...
  After the response, add a "SOLVED BY HISTORY PROFESOR"
    Here is a question:
    {input}`
